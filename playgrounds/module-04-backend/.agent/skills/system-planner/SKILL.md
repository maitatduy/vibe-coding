...
1. **Đọc file `AGENT.md`**: Để nắm bắt bắt buộc Stack công nghệ của dự án (VD: Node.js, Express, Redis, RabbitMQ...) và các quy tắc lập trình cốt lõi. BẠN BỊ CẤM đề xuất các công nghệ nằm ngoài danh sách này.
...
_"✅ Đã hoàn tất bản quy hoạch Back-end tại file [Tên file]. Sẵn sàng cho Antigravity thi công API."_
